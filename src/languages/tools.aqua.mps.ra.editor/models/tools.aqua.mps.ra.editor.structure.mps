...
<model ref="r:21da5544-2cb1-4bc6-8abc-4ed5bfb77d43(tools.aqua.mps.ra.editor.structure)">
  ...
  <node concept="1TIwiD" id="4cCb6PI$LU5">
    ...
    <node concept="1TJgyi" id="1OjSjUCzLNe" role="1TKVEl">
      <property role="IQ2nx" value="2095265910889585870" />
  ...
  <node concept="PlHQZ" id="3TMopQL2TJA">
    ...
    <node concept="PrWs8" id="1_71nTAd1yD" role="PrDN$">
      <ref role="PrY4T" node="1_71nTA8qFa" resolve="IRegisterAutomatonElement" />
    </node>
  </node>
